...
This Program copies the data from Production DBs to Backup DBs in Real time
...
### 1. Clone & Setup
```
git clone https://github.com/Bas3line/db-mirror-orch.git
cd db-mirror-orch
...
- 🐛 **Issues**: [GitHub Issues](https://github.com/Bas3line/db-mirror-orch/issues)
- 💬 **Discussions**: [GitHub Discussions](https://github.com/Bas3line/db-mirror-orch/discussions)
